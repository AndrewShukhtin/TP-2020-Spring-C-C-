...
[![Build Status](https://travis-ci.org/AndrewShukhtin/TP-2020-Spring-C-Cpp.svg?branch=hw-2)](https://travis-ci.org/AndrewShukhtin/TP-2020-Spring-C-Cpp)
[![codecov](https://codecov.io/gh/AndrewShukhtin/TP-2020-Spring-C-Cpp/branch/hw-2/graph/badge.svg)](https://codecov.io/gh/AndrewShukhtin/TP-2020-Spring-C-Cpp)
...
**Таблица сравнения времени выполнения последовательного алгоритма и параллельного**
- **Intel® Core™ i5-8257U**: 4CPUs, 2 threads per CPU core, 32KB L1 cache size
- dimension = 3 
- size = 67108864
- data size 1.4GB

Sequential (ms) | Parallel (ms) | Ratio
 --- | --- | ---
 589 | 131 | 4.49
 580 | 120 | 4.83
 553 | 130 | 4.25
